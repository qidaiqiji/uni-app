<template>
	<view class="uni-column">
		<!-- id="content" -->
		<view class="content" :style="{height:style.contentViewHeight+'px'}">
			<scroll-view class="scrollview"   scroll-y="true" :style="{height:style.contentViewHeight+'px'}" :scroll-with-animation="true"
			    :scroll-top="scrollTop">
				<message-show v-for="(message,index) in messages" :key="index" v-bind:message="message" :uid="index"></message-show>
				<view id="bottom"></view>
			</scroll-view>
		</view>
		<view class="foot">
