<template>
	<view class="m-item" :id="getUid">
		<view class="m-left"><image class="head_icon" :src="user.home.img" v-if="message.user == 'home'"></image></view>
		...
		<view class="m-right"><image class="head_icon" :src="user.customer.img" v-if="message.user == 'customer'"></image></view>
	</view>
</template>
