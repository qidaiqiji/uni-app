<template>
    <view class="uni-popup-box">
        <view class="uni-mask" :class="{ show: show }" :style="{ top: offsetTop + 'px' }" @tap="hide" @touchmove.stop.prevent="moveHandle" catchtouchmove="true"></view>
        <view class="uni-popup uni-popup-bottom" :class="{ show: show }">
            <view class="uni-animation">
                {{ msg }}
                <slot></slot>
                <view
